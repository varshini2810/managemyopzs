    ...
    <div>
      ...
      <div className="module-header">
        ...
        <div className="breadcrumb">
          ...
          <span className="breadcrumb-current">Referral Programs</span>{" "}
        </div>{" "}
      </div>{" "}
      <div className="px-8 py-8 max-w-7xl mx-auto">
        {" "}
        <h1 className="page-title">Referral Programs</h1>{" "}
        <p className="page-subtitle">Manage your referral programs</p>{" "}
