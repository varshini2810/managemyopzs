        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="card p-6 space-y-4">
            ...
            <div>
              ...
              />{" "}
              {errors.customerId && (
                <p className="error-msg">{errors.customerId.message}</p>
              )}{" "}
            ...
            <div>
              ...
              <input
                type="text"
                className={`input ${errors.planId ? "input-error" : ""}`}
                placeholder="pln-..."
            ...
            <div>
              {" "}
              <label className="label">
                Price Point ID <span className="text-red-500">*</span>
              </label>{" "}
              <input
                type="text"
                className={`input ${errors.pricePointId ? "input-error" : ""}`}
                placeholder="ppp-..."
                {...register("pricePointId", {
                  required: "Price Point ID is required",
                })}
              />{" "}
            </div>{" "}
          </div>{" "}
