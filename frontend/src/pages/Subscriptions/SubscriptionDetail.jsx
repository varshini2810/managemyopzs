        ...
        <div className="flex items-start justify-between">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 text-sm text-muted">
              {" "}
              <span>
                Customer: <MonoId id={sub.customerId} />
              </span>{" "}
              <span>
                Plan: <MonoId id={sub.planId} />
              </span>{" "}
            </div>{" "}
          </div>{" "}
            ...
            <div className="card p-6">
              ...
              <dl className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  <dt className="text-muted">Current Term Start</dt>
                  <dd className="font-medium">
                    {new Date(sub.currentTermStart).toLocaleDateString()}
                  </dd>
                </div>{" "}
                <div className="flex justify-between">
                  <dt className="text-muted">Current Term End</dt>
                  <dd className="font-medium">
                    {new Date(sub.currentTermEnd).toLocaleDateString()}
                  </dd>
                </div>{" "}
                <div className="flex justify-between">
                  <dt className="text-muted">Next Billing At</dt>
            ...
            <div className="card p-6">
              ...
              <dl className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <dd className="font-medium">
                    <MonoId id={sub.planId} />
                  </dd>
                </div>{" "}
                <div className="flex justify-between">
                  <dt className="text-muted">Price Point</dt>
                  <dd className="font-medium">
                    <MonoId id={sub.pricePointId} />
                  </dd>
                </div>{" "}
              </dl>{" "}
            </div>{" "}
            ...
            <div className="space-y-4">
              ...
              {events.map((evt) => (
                <div key={evt.id} className="flex gap-4">
                  {" "}
                  <div className="w-24 text-xs text-muted pt-0.5">
