...
export default function PricePointModal({
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.error(
        err.response?.data?.message || "Failed to create price point",
      );
    }
  };
  return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Shown to customers on checkout
                </p>{" "}
                {errors.externalName && (
                  <p className="error-msg">{errors.externalName.message}</p>
                )}{" "}
              </div>{" "}
              <div>
                {" "}
                ...
                {errors.internalName && (
                  <p className="error-msg">{errors.internalName.message}</p>
                )}{" "}
              </div>{" "}
            </div>{" "}
            <div>
