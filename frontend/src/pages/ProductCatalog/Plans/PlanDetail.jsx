  ...
  if (loading || !plan) {
    return (
      <div className="px-8 py-8 space-y-6 animate-pulse">
        {" "}
        <div
          className="h-5 w-48 rounded skeleton"
