...
export default function CreateAddonModal({ isOpen, onClose, onSuccess, initialData }) {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      api.get('/custom-fields?entityType=addon')
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={isEditing ? 'Edit Addon' : 'Create Addon'} maxWidth="max-w-2xl">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="label">Addon Name <span className="text-red-500">*</span></label>
                <input 
                  type="text" 
          ...
          <div className="md:col-span-2 space-y-4 pt-4 border-t border-slate-100">
            <h4 className="font-semibold text-slate-800 text-sm uppercase tracking-wider">Pricing</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select className="select" {...register('chargeType')}>
                  <option value="recurring">Recurring (billed with plan)</option>
          ...
          <div className="md:col-span-2 space-y-4 pt-4 border-t border-slate-100">
            <h4 className="font-semibold text-slate-800 text-sm uppercase tracking-wider">Custom Fields</h4>
            <div className="grid grid-cols-1 gap-4">
              {customFields.length === 0 ? (
                <p className="text-sm text-muted">No custom fields defined for Addons.</p>
              ) : (
                customFields.map(cf => (
                  <div key={cf.id}>
