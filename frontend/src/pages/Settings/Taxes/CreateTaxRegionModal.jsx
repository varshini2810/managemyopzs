  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Add Tax Region">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          <label className="label">Country (2-letter code) <span className="text-red-500">*</span></label>
          <input 
            type="text" 
            className={`input ${errors.country ? 'input-error' : ''} uppercase`}
            placeholder="e.g. US, GB, DE"
            maxLength={2}
            {...register('country', { required: 'Country code is required', maxLength: 2, minLength: 2 })}
          />
        ...
        <div>
          <label className="label">Tax Name <span className="text-red-500">*</span></label>
          <input 
            type="text" 
          ...
          />
          {errors.taxName && <p className="error-msg">{errors.taxName.message}</p>}
        </div>

        <div>
          <label className="label">Tax Rate (%) <span className="text-red-500">*</span></label>
          <input 
            type="number" 
            step="0.01"
          ...
          />
          {errors.taxRate && <p className="error-msg">{errors.taxRate.message}</p>}
        </div>
