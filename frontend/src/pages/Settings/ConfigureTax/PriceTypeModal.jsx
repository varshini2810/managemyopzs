...
export default function PriceTypeModal({
  isOpen,
  onClose,
  currency,
  currentType,
        ...
        <div className="p-6 space-y-3">
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm font-medium text-ink">
                My prices are exclusive of the tax
              </div>{" "}
              <div className="text-xs text-muted mt-0.5 leading-relaxed">
                {" "}
                Pick this option if tax is not included in your catalog
                prices.{" "}
              </div>{" "}
            </div>{" "}
          </label>{" "}
          ...
          >
            ...
            <div>
              {" "}
              <div className="text-sm font-medium text-ink">
                My prices are inclusive of the tax
              </div>{" "}
              <div className="text-xs text-muted mt-0.5 leading-relaxed">
                {" "}
