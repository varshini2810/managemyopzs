...
const CATEGORIES = [
  { name: "Onboarding Emails", desc: "Welcome emails for new customers." },
  {
    ...
    desc: "Notify customers when subscriptions become active.",
  },
  {
    name: "Trial Management",
    desc: "Trial start, extension, and expiration notifications.",
  },
  {
    name: "Subscription Changes",
    desc: "Plan upgrades, downgrades, and modifications.",
  },
  ...
  { name: "Payment Success", desc: "Successful payment confirmations." },
  {
    ...
    desc: "Failed payment alerts and retry notifications.",
  },
  ...
  { name: "Credit Notes", desc: "Credit note issuance notifications." },
  {
    ...
    desc: "Finance-related alerts and statements.",
  },
  {
    name: "Payment Statements",
    desc: "Monthly and custom payment statement emails.",
  },
];
    ...
    <div className="p-8 max-w-7xl mx-auto font-sans">
      ...
      <div className="mb-8">
        ...
        <p className="text-stone-600 max-w-3xl">
          {" "}
          Manage and customize all automated email notifications sent to
          customers regarding subscriptions, invoices, payments, onboarding, and
          account activities.{" "}
        </p>{" "}
      </div>{" "}
      {/* Top Summary Section */}{" "}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-white p-6 rounded-card shadow-sm border border-stone-200">
          ...
          <p className="text-sm text-stone-600 mb-6 min-h-[40px]">
            {" "}
            Configure custom SMTP server or use the default system email
            service.{" "}
          </p>{" "}
          <button className="text-sm font-medium text-blue-600 hover:text-blue-800 transition-colors">
            {" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 pb-20">
        ...
        {CATEGORIES.map((cat) => (
          ...
          >
            ...
            <div>
              {" "}
              <h3 className="font-semibold text-stone-900 mb-2 group-hover:text-blue-600 transition-colors">
                {cat.name}
              </h3>{" "}
            ...
            <div className="mt-4 flex justify-end">
              ...
              <ChevronRight
                size={18}
                className="text-stone-400 group-hover:text-blue-600"
              />{" "}
            </div>{" "}
          </div>
        ))}{" "}
