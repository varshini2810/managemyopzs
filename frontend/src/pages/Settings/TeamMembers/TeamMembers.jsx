          ...
          <table className="w-full text-left text-sm">
            <thead className="bg-surface-100 text-muted">
              <tr>
                ...
                <th className="p-4 font-medium">Status</th></tr></thead>{" "}
              ...
              {loading ? (
                ...
                members.map((m) => (
                  <tr key={m.id} className="hover:bg-surface-50">
                    ...
                    <td className="p-4">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-semibold ${m.status === "ACTIVE" ? "bg-emerald-500/10 text-emerald-600" : "bg-amber-500/10 text-amber-600"}`}
                      >
                        {m.status}{" "}
                      </span>{" "}
                    </td></tr>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-indigo-500/10 border border-indigo-500/20 rounded-card">
                  ...
                  <p className="text-sm text-muted mb-4">
                    Please share this secure link with the team member to
                    complete their setup and password creation.
                  </p>{" "}
              ...
              <form onSubmit={handleInvite} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setInviteForm({ ...inviteForm, roleName: e.target.value })
                    }
                  >
                    {" "}
