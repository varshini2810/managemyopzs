    ...
    <div className="flex justify-center items-start w-full">
      <div className="bg-white shadow-lg rounded-sm border border-stone-200 w-full max-w-2xl p-8 font-sans">
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            {logoUrl ? (
              <img src={logoUrl} alt="Logo" className="max-h-10 object-contain mb-4" />
            ) : (
              <div className="text-xs font-bold text-stone-400 tracking-widest mb-4">YOUR LOGO GOES HERE</div>
            )}
            <h1 className="text-2xl font-light text-stone-900" style={{ color: accentColor || '#2196F3' }}>INVOICE</h1>
        ...
        <div className="flex justify-between mb-8 pb-6 border-b border-stone-100">
          ...
          <div className="text-sm text-right flex flex-col gap-2">
            <div>
              <p className="text-stone-400 inline-block w-24">Issue Date:</p>
              <p className="text-stone-700 inline-block font-medium">Oct 12, 2023</p>
            </div>
            <div>
              <p className="text-stone-400 inline-block w-24">Due Date:</p>
              <p className="text-stone-700 inline-block font-medium">Oct 26, 2023</p>
            </div>
            <div className="mt-2">
              <span 
                className="inline-block px-3 py-1 rounded-full text-xs font-semibold"
                style={{ backgroundColor: `${accentColor || '#2196F3'}20`, color: accentColor || '#2196F3' }}
              >
                UNPAID
              </span>
            </div>
          ...
          <table className="w-full text-sm text-left">
            <thead>
              <tr className="border-b border-stone-200">
                <th className="py-2 font-medium text-stone-500">Description</th>
                <th className="py-2 font-medium text-stone-500 text-right">Qty</th>
                <th className="py-2 font-medium text-stone-500 text-right">Price</th>
                <th className="py-2 font-medium text-stone-500 text-right">Amount</th>
              </tr>
            </thead>
            <tbody className="text-stone-700">
              <tr className="border-b border-stone-100">
                ...
                <td className="py-3 text-right font-medium">$49.00</td>
              </tr>
            </tbody>
          </table>
        </div>
