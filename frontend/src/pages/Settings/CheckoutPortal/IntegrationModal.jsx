      ...
      <div className="bg-white rounded-card shadow-xl w-full max-w-[900px] max-h-[90vh] flex flex-col overflow-hidden animate-scale-up">
        ...
        <div className="flex px-6 border-b border-gray-200 shrink-0 bg-gray-50">
          ...
          <button
            ...
            className={`px-4 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === "script" ? "border-gray-900 text-gray-900" : "border-transparent text-gray-500 hover:text-gray-700"}`}
          >
            {" "}
            Via Drop-in Script{" "}
          </button>{" "}
          <button
            ...
            className={`px-4 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === "api" ? "border-gray-900 text-gray-900" : "border-transparent text-gray-500 hover:text-gray-700"}`}
          >
            {" "}
            Via API{" "}
          </button>{" "}
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                ...
                <div>
                  ...
                  <h3 className="text-sm font-semibold text-gray-900 flex items-center gap-2">
                    {" "}
                    <TerminalSquare size={16} className="text-[#6D28D9]" />{" "}
                    Header Script{" "}
                  </h3>{" "}
                  <p className="text-xs text-gray-500 mt-2 leading-relaxed">
                    {" "}
                    Copy and paste the code into the HTML header of your
                    website/application. This needs to be done only once.{" "}
                  </p>{" "}
                </div>{" "}
              ...
              <div>
                ...
                <h3 className="text-sm font-semibold text-gray-900 flex items-center gap-2 mb-2">
                  {" "}
                  <Code2 size={16} className="text-[#6D28D9]" /> Checkout Button
                  Code{" "}
                </h3>{" "}
                <p className="text-xs text-gray-500 mb-6">
                  {" "}
                  Choose the product family, plan, currency, billing frequency,
                  addons, and charges to generate OPZ checkout code.{" "}
                </p>{" "}
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                      ...
                      {addons.map((addon) => (
                        <span
                          key={addon}
                          className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-[#F3E8FF] text-[#6D28D9]"
                        >
                          {" "}
                          {addon}{" "}
                          <button
                            onClick={() => toggleAddon(addon)}
                            className="hover:bg-[#6D28D9] hover:text-white rounded-full p-0.5"
                          >
                            <X size={10} />
                          </button>{" "}
                        </span>
                      ...
                      <div className="relative">
                        ...
                        <button
                          onClick={() =>
                            setOpenDropdown(
                              openDropdown === "addons" ? null : "addons",
                            )
                          }
                          ...
                          <div className="absolute left-0 mt-1 w-48 bg-white border border-gray-200 rounded-card shadow-lg z-10 py-1">
                            ...
                            {ADDON_OPTIONS.map((opt) => (
                              <button
                                ...
                                className="w-full text-left px-4 py-2 text-xs hover:bg-gray-50 flex justify-between items-center text-gray-700"
                              >
                                {" "}
                                {opt}{" "}
                                {addons.includes(opt) && (
                      ...
                      {charges.map((charge) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="hover:bg-gray-300 hover:text-gray-900 rounded-full p-0.5"
                          >
                            <X size={10} />
                          </button>{" "}
                        </span>
          ...
          {activeTab === "api" && (
            <div className="space-y-6">
              ...
              <p className="text-xs text-gray-500">
                Use our REST API to generate checkout sessions dynamically on
                your backend.
              </p>{" "}
