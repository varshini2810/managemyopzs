...
export default function CheckoutPortalDashboard() {
  ...
  const tabs = ['Configuration', 'Fields', 'Labels', 'Integrate with Chargebee'];
  const menuItems = ['Checkout', 'Portal', 'Portal for Contract Terms', 'Advanced Settings', 'Gift Subscription'];
    ...
    return (
      <div className="h-full w-full bg-white flex items-center justify-center">
        <div className="flex flex-col items-center">
          <div className="w-8 h-8 border-4 border-[#6D28D9]/30 border-t-[#6D28D9] rounded-full animate-spin mb-4"></div>
          <p className="text-gray-500 text-sm font-medium">Loading Checkout Settings...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="h-full w-full bg-white flex flex-col font-sans animate-fade-in relative">
      ...
      <div className="px-8 pt-8 pb-4 border-b border-gray-200 shrink-0">
        <div className="flex items-center text-sm text-gray-500 mb-4">
          ...
          <span className="font-semibold text-gray-900">Checkout & Self-Serve Portal</span>
        </div>
        <h1 className="text-2xl font-semibold text-gray-900 mb-1">Checkout & Self-Serve Portal</h1>
        <p className="text-sm text-gray-500">Customize checkout and customer self-service portal settings.</p>
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            {activeTab === 'Integrate with Chargebee' ? (
              <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm text-center">
                <div className="mx-auto w-16 h-16 bg-[#F3E8FF] rounded-full flex items-center justify-center mb-4">
                  <Code2 size={32} className="text-[#6D28D9]" />
                </div>
                <h2 className="text-xl font-semibold text-gray-900 mb-2">Integrate OPZ Checkout</h2>
                <p className="text-sm text-gray-500 mb-6 max-w-md mx-auto">
                  Generate drop-in scripts or explore our REST API to seamlessly integrate OPZ checkout flows into your application.
                </p>
                <button 
              ...
              <>
                {/* Branding Banner */}
                <div className="bg-gradient-to-r from-[#6D28D9] to-[#8B5CF6] rounded-lg p-6 text-white flex items-center justify-between shadow-sm">
                  <div className="flex items-center gap-4">
                    <div className="bg-white/20 p-3 rounded-full">
                      <ImageIcon size={24} className="text-white" />
                    </div>
                    <p className="font-medium text-lg">Kick things off by customizing how your portal will look to customers</p>
                  </div>
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900 mb-1">Checkout</h2>
                  <p className="text-sm text-gray-500 mb-4">
                    Onboard new customers and help existing customers manage subscriptions through the checkout experience.
                  </p>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                    ...
                    <div className="flex items-center justify-between p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors">
                      <div className="text-sm font-medium text-gray-800">Customers can access the checkout</div>
                      <select 
                        ...
                        onChange={(e) => setSettings({...settings, accessCheckout: e.target.value})}
                      >
...
function ToggleRow({ label, checked, onChange, last }) {
  return (
    <div className={`flex items-center justify-between p-4 hover:bg-gray-50 transition-colors ${!last ? 'border-b border-gray-100' : ''}`}>
