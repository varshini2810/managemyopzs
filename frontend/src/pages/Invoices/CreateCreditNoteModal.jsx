  ...
  const onSubmit = async (data) => {
    try {
      ...
      const payload = {
        ...
        customExpenseLabel:
          data.expenseType === "Other" ? data.customExpenseLabel : null,
        expenseCost:
          data.type === "EXPENSE" ? parseFloat(data.expenseCost) : null,
        lineItems:
          data.type !== "EXPENSE"
            ? [
                {
        ...
        {selectedType === "EXPENSE" ? (
          <>
            ...
            {selectedExpenseType === "Other" && (
              <div>
                ...
                <input
                  ...
                  {...register("customExpenseLabel", {
                    required: selectedExpenseType === "Other",
                  })}
                />{" "}
              </div>
            )}{" "}
            <div>
              {" "}
              <label className="label">
                Expense Cost ($) <span className="text-red-500">*</span>
              </label>{" "}
              <input
                type="number"
                step="0.01"
