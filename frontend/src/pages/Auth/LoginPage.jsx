      ...
      >
        ...
        <div className="relative z-10">
          <h1
            ...
            style={{ fontSize: 32, lineHeight: '38px', letterSpacing: '-0.03em' }}
          >
            Revenue clarity.<br />
            Built for billing teams.
          </h1>
          <p className="text-sm" style={{ color: '#79756E', lineHeight: '22px', maxWidth: 320 }}>
            Manage subscriptions, plans, pricing, and revenue metrics
            from a single enterprise-grade dashboard.
          </p>
          ...
          >
            {[
              { label: 'Monthly Recurring Revenue', val: '$15,450', pct: '+5.4%', up: true },
              { label: 'Active Subscriptions', val: '128', pct: '+1.2%', up: true },
              { label: 'Unpaid Invoices', val: '$1,330', pct: '–15.4%', up: false },
            ].map((m, i) => (
              <div key={i} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <div className="text-2xs" style={{ color: '#57534E' }}>{m.label}</div>
                    <div
                      className="font-display font-semibold tabular-nums"
                      style={{ color: '#FFFFFF', fontSize: 16, letterSpacing: '-0.02em' }}
                    >
                      {m.val}
                    </div>
                  </div>
