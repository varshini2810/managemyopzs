    ...
    <div className="p-8 max-w-7xl mx-auto space-y-6 animate-fade-in">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Track your targets and get notified of anomalies.</p>
        </div>
        <div className="flex items-center gap-3">
          <button className="btn-primary">
            <Plus size={14} /> {tab === 'alerts' ? 'Create Alert' : 'Create Goal'}
          </button>
        </div>
      </div>
        ...
        <div className="card p-0">
          <div className="tbl-wrapper">
            <table className="tbl">
              ...
              <tbody>
                <tr>
                  <td className="font-medium text-ink">High Churn Warning</td>
                  <td>Churn Rate</td>
                  <td>Increases by &gt; 5%</td>
        ...
        <div className="card p-0">
          <div className="tbl-wrapper">
            <table className="tbl">
              ...
              <tbody>
                <tr>
                  <td className="font-medium text-ink">Q3 Revenue Target</td>
                  <td>MRR ($500k)</td>
                  <td>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-2xs text-muted tabular-nums">80%</span>
                    </div>
                  </td>
                  <td>Sep 30, 2026</td>
                  <td><span className="status-dot active">On Track</span></td>
                </tr>
              </tbody>
            </table>
          </div>
