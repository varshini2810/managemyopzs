  ...
  const metrics = [
    {
      ...
      val: formatCurrency(data.metrics.mrr),
      trend: "+12%",
      up: true,
    },
    {
      label: "Active Subscriptions",
      val: data.metrics.activeSubscriptions || 0,
      trend: "+5%",
      up: true,
    },
    {
      label: "Total Customers",
      val: data.metrics.totalCustomers || 0,
      trend: "+2%",
      up: true,
    },
    {
      label: "Churn Rate",
      val: data.metrics.churnRate || "0%",
      trend: "-1%",
      up: false,
    },
      ...
      <div className="page-header">
        ...
        <div>
          ...
          <p className="page-subtitle">
            Your key revenue metrics at a glance.
          </p>{" "}
        </div>{" "}
        <div className="flex items-center gap-3">
          ...
          <select className="select w-48">
            ...
            <option>Last 12 Months</option> <option>Custom Range</option>{" "}
          </select>{" "}
      ...
      <div className="grid grid-cols-5 gap-4">
        ...
        {metrics.map((m) => (
          <div key={m.label} className="card-sm flex flex-col gap-2">
            ...
            <div
              className={`text-xs font-medium flex items-center gap-1 ${m.up ? "text-success" : "text-danger"}`}
            >
              {" "}
              {m.up ? (
