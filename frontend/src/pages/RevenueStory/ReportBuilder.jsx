      ...
      <div className="page-header">
        ...
        <div>
          ...
          <p className="page-subtitle">
            Create, preview, and save custom reports.
          </p>{" "}
        </div>{" "}
        <div className="flex items-center gap-3">
          {" "}
          <button className="btn-secondary">
            <Mail size={14} /> Save & Schedule
          </button>{" "}
        ...
        <div className="w-80 flex flex-col gap-6 overflow-y-auto">
          ...
          <div className="card p-4 space-y-4">
            ...
            <div>
              ...
              <div className="space-y-2 mt-2">
                ...
                <label className="flex items-center gap-2 text-sm">
                  <input type="checkbox" defaultChecked /> Customer ID
                </label>{" "}
                <label className="flex items-center gap-2 text-sm">
                  <input type="checkbox" defaultChecked /> Plan Name
                </label>{" "}
                <label className="flex items-center gap-2 text-sm">
                  <input type="checkbox" defaultChecked /> MRR
                </label>{" "}
                <label className="flex items-center gap-2 text-sm">
            ...
            <div>
              ...
              <button className="btn-ghost btn-sm w-full border border-dashed border-border mt-1">
