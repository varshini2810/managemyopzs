...
// Custom pill toggle — replaces all default checkboxes for settings toggles
  ...
  return (
    <label className="flex items-center gap-3 cursor-pointer select-none">
      <button
        ...
        className="relative inline-flex shrink-0 h-5 w-9 rounded-full border-2 border-transparent
