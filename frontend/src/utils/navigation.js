...
const receivablesNavItems = [
  {
    ...
    to: "/receivables/dashboard",
  },
  {
    id: "collections",
    label: "Collections Queue",
    icon: List,
    to: "/receivables/collections-queue",
  },
  {
    id: "reconciliation",
    label: "Payment Reconciliation",
    icon: Link,
    to: "/receivables/reconciliation",
  },
  {
    id: "disputes",
    label: "Dispute Management",
    icon: AlertTriangle,
    to: "/receivables/disputes",
  },
  {
    id: "write-off",
    label: "Bad Debt Write-off",
    icon: FileCheck,
    to: "/receivables/write-off",
  },
];
...
const retentionNavItems = [
  {
    ...
    label: "Cancel Flows",
    icon: RotateCcw,
    to: "/retention/cancel-flows",
  },
  {
    id: "churn-reasons",
    label: "Churn Reasons",
    icon: PieChart,
    to: "/retention/churn-reasons",
  },
  {
    id: "winback",
    label: "Winback Campaigns",
    icon: ActivitySquare,
    to: "/retention/winback",
  },
  {
    id: "at-risk",
    label: "At-Risk Signals",
    icon: AlertTriangle,
    to: "/retention/at-risk",
  },
  {
    id: "activity-log",
    label: "Activity Log",
    icon: History,
    to: "/retention/activity-log",
  },
];
...
const revrecNavItems = [
  ...
  },
  {
    ...
    icon: CheckCircle,
    to: "/revrec/obligations",
  },
  {
    id: "modifications",
    label: "Contract Modifications",
    icon: ArrowRightLeft,
    to: "/revrec/modifications",
  },
  {
    id: "journal-entries",
    label: "Journal Entries",
    icon: FileText,
    to: "/revrec/journal-entries",
  },
  {
    id: "audit-trail",
    label: "Audit Trail",
    icon: Lock,
    to: "/revrec/audit-trail",
  },
];
...
const growthNavItems = [
  {
    ...
    icon: TestTube,
    to: "/growth/pricing-experiments",
  },
  {
    id: "checkout-optimization",
    label: "Checkout Optimization",
    icon: LineChart,
    to: "/growth/checkout-optimization",
  },
  {
    id: "upsell-rules",
    label: "Upsell/Cross-sell Rules",
    icon: ArrowRightLeft,
    to: "/growth/upsell-rules",
  },
  {
    id: "referrals",
...
export function getNavigationForRole(role, currentSuite, grantedModules = []) {
  ...
  // Helper to check if an item is explicitly granted via its backend module key
  ...
  return baseItems.map(item => { 
    ...
    if (upperRole === 'ULTRASUPERADMIN') { 
      // Sees everything in standard nav — including ultrasuperadminOnly items.
      return processedItem; 
    } 
    // For all non-Ultra Admin roles: strip out ultrasuperadminOnly sub-items
    if (processedItem.subItems) { 
      processedItem = { 
        ...processedItem, 
        subItems: processedItem.subItems.filter(sub => !sub.ultrasuperadminOnly), 
      }; 
    } 
    if (upperRole === 'SUPERADMIN') { 
      // Sees everything in standard nav, no other restrictions.
      return processedItem; 
    } 
    if (upperRole === 'ADMIN') { 
