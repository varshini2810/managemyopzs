...
import com.billingplatform.service.PdfGeneratorService;
import com.billingplatform.service.InvoiceNotificationService;
import com.billingplatform.service.InvoiceService;
...
public class InvoiceController {
    ...
    public ResponseEntity<?> getInvoicePdf(@PathVariable String id, Authentication auth) {
        ...
        } catch (com.billingplatform.exception.ResourceNotFoundException e) {
            return ResponseEntity.status(org.springframework.http.HttpStatus.NOT_FOUND)
                    .body(java.util.Map.of("success", false, "message", "Invoice not found"));
        } catch (Exception e) {
