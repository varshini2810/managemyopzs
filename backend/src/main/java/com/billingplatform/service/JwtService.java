...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        if (userDetails instanceof CustomUserDetails) {
            ...
            extraClaims.put("tenantId", customUser.getTenantId());
            extraClaims.put("role", customUser.getRole());
            extraClaims.put("permissions", customUser.getPermissions());
            extraClaims.put("grantedModules", customUser.getGrantedModules());
        }
