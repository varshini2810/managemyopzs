package com.billingplatform.config;
...
import com.billingplatform.model.RateLimitFilter;
...
import com.billingplatform.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public RoleHierarchy roleHierarchy() {
        return RoleHierarchyImpl.fromHierarchy("ROLE_ULTRASUPERADMIN > ROLE_SUPERADMIN \n ROLE_SUPERADMIN > ROLE_ADMIN \n ROLE_ADMIN > ROLE_USER");
    }
    ...
    public UserDetailsService userDetailsService() {
        return username -> {
            ...
            if (tenantId != null) {
                java.util.List<com.billingplatform.model.TenantModuleAccess> accessList = tenantModuleAccessRepository.findByTenantId(tenantId);
                for (com.billingplatform.model.TenantModuleAccess access : accessList) {
